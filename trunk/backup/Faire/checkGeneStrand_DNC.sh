...
# $1 prefix
closestBed -a $10.clust.bed -b ~/Faire/data/knownGene.bed -t first |cut -f12|sort |uniq -c
closestBed -a $11.clust.bed -b ~/Faire/data/knownGene.bed -t first |cut -f12|sort |uniq -c
closestBed -a $12.clust.bed -b ~/Faire/data/knownGene.bed -t first |cut -f12|sort |uniq -c
closestBed -a $13.clust.bed -b ~/Faire/data/knownGene.bed -t first |cut -f12|sort |uniq -c
closestBed -a $14.clust.bed -b ~/Faire/data/knownGene.bed -t first |cut -f12|sort |uniq -c
