...
if len(sys.argv)<2:
    ...
    print '2. supported formats: bed3-12, bigWig, bigBed, vcf, psl, bam, encodeNarrowPeak'
...
for line in fi:
    ...
    tags=temp[6]
    bcs=temp[7].strip('/')
    if 'bed' in format or 'vcf' in format or 'psl' in format or 'encodeNarrowPeak' in format or 'chiapet.itx' in format:
    	driver='mysql_table'
